...
public class MovieDataManager {
	public static void main(String[] args)
	{
		...
		File file=new File("/home/sist/bigdataStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/BigMovieProject/desc.txt");
		if(file.exists())
			file.delete();
		
		for(int i=1;i<=3;i++)
		{
		  String json=m.movie_review("수상한 그녀", i);
		  m.json_parse(json);
		}
	}
    public static List<MovieDTO> movieAllData()
    {
    	...
    	try
    	{
    		...
    		{
    			Element telem=titleElem.get(i); // ttp://www.mvnrepository.com/search?q=hadoop-common
	...
	public void json_parse(String json)
	{
		try
		{
			...
			FileWriter fw=new FileWriter("/home/sist/bigdataStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/BigMovieProject/desc.txt",true);
			fw.write(desc);
			fw.close();
		}catch(Exception ex)
		{
	...
	public FeelVO rGraph(String t)
	{
		...
		try
		{
			...
			rc.voidEval("review<-read.table(\"/home/sist/bigdataStudy/BigMovieProject/output/part-r-00000\")");
			/*
		   rc.voidEval("png(\"/home/sist/bigdataStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/BigMovieProject/recommend.png\",width=800,height=600)");
		    rc.voidEval("par(mfrow=c(1,2))");
		    rc.voidEval("pie(review$V2,labels=review$V1,col=rainbow(15))");
		    rc.voidEval("barplot(review$V2)");
		    rc.voidEval("dev.off()"); */
	...
	public List<String> read_review()
	{
		...
		try
		{
			...
			rc.voidEval("review<-readLines(\"/home/sist/bigdataStudy/BigMovieProject/output/part-r-00000\")");
			REXP p=rc.eval("/home/sist/bigdataStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/BigMovieProject/recommend.png");
